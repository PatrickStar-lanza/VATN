...
class Block_head(nn.Module):
    def __init__(self, d_model=1024 , dropout = 0.3, head=heads_number):
    ...
    def forward(self, q, k, v, mask=None):
        ...
        q = F.gelu(self.q_linear(q).view(bs, self.head, self.d_k))
...
class Tail(nn.Module):
    def __init__(self, num_classes , num_frames, head=heads_number):
